<template>
  <ClientOnly>
    <div class="HomeCommunitiesHorizontalSlider">
      ...
      <swiper
        ref="homeCommunitiesHorizontalSlider"
        class="swiper"
      ...
      >
        <HomeCommunitiesHorizontalSliderItem
...
export default {
  ...
  methods: {
    ...
    homeCommunitiesSwipeNextSlide () {
      return this.$refs.homeCommunitiesHorizontalSlider.$swiper.slidePrev()
    },
  },
}
</script>
