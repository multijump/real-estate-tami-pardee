<template>
  <div class="HomeNewsSliderItem">
    <div class="HomeNewsSliderItem__overlay" />
    ...
    <div class="HomeNewsSliderItem__content">
      <div class="HomeNewsSliderItem__image">
        <PlayImage
          v-if="item.post_video"
          class="HomeNewsSliderItem__play"
      ...
      <div class="HomeNewsSliderItem__text">
        <h3 class="HomeNewsSliderItem__title">
          {{ item.post_title }}
        </h3>
    ...
    <div class="HomeNewsSliderItem__date">
