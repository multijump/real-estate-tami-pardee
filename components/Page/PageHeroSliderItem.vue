<template>
  <swiper-slide>
    <div class="PageHeroSliderItem">
      <div class="PageHeroSliderItem__bg--top" />
      <div class="PageHeroSliderItem__bg--bottom" />
      ...
      <div class="PageHeroSliderItem__content container">
        <AppSectionTitle
          v-if="item.title"
          :display="pretitle"
          :title="title"
